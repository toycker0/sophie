...
export const zh: Messages = {
 ...
 "step": "步骤01",
 "title": "上下文注入",
 "description": "旅行、工作、约会或与房东争吵。Sophie使模拟适应您的实际生活，而不是教科书。"
 },
 {
 "step": "步骤02",
 "title": "主动模拟",
 "description": "没有多项选择。没有敲击的话。只是说话。Sophie按照您的水平做出反应，每次都会稍微推动您 (i+1)。"
 },
 {
 "step": "步骤03",
 "title": "神经重写",
 "description": "即时纠正发音和风格。Sophie在坏习惯养成之前重写你的神经通路。"
 }
 ]
 },
 "features": {
 ...
 "answer": "是的！您可以在设置中在 {language} 的不同地区口音和方言之间切换。Sophie会调整她的词汇、常用表达和发音，以匹配您关注的特定区域。"
 },
 {
 ...
 "answer": "Sophie使用“上下文优先”的方法。她没有让您进行练习，而是将您置于自然需要复杂 {language} 语法的现实场景中。如果你犯了错误，她会实时提供温和、建设性的反馈。"
 },
 {
 ...
 "answer": "确实。您可以从数十种预设场景中进行选择，例如在咖啡馆点餐、商务会议或第一次约会，或者创建自己的自定义主题。Sophie几乎可以处理您想要进行的任何对话。"
 },
 {
 ...
 "testimonial": "Sophie从第一天开始就催促我发言。它令人难以置信的无缝、自然和有效。",
 ...
 "childrenBody": "与Sophie交谈不针对 13 岁以下的儿童。我们不会故意收集 13 岁以下儿童的个人信息。如果您是父母或监护人，并且认为您的孩子已向我们提供了个人数据，请与我们联系，以便我们采取适当的行动。",
 ...
 "sectionNeuroP2": "这就是为什么人工智能可以成为强大的实践伙伴。Sophie不会评判你，也不会催促你。她纠正并继续前进，这会降低情感过滤器并帮助你的大脑承担风险。",

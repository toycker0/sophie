...
export const ar: Messages = {
    ...
    "steps": [
      {
        "step": "الخطوة 01",
        "title": "حقن السياق",
        "description": "السفر أو العمل أو المواعدة أو الجدال مع مالك العقار. تقوم Sophie بتكييف المحاكاة مع حياتك الفعلية، وليس مع كتاب مدرسي."
      },
      {
        "step": "الخطوة 02",
        "title": "محاكاة نشطة",
        "description": "لا يوجد خيار متعدد. لا التنصت الكلمات. فقط تحدث. تستجيب Sophie بمستواك، وتدفعك قليلاً في كل مرة (i+1)."
      },
      {
        "step": "الخطوة 03",
        "title": "إعادة الكتابة العصبية",
        "description": "احصل على تصحيحات فورية على النطق والأسلوب. تعيد \"Sophie\" كتابة مساراتك العصبية قبل ظهور العادات السيئة."
      }
    ]
  },
  "features": {
    ...
    "cards": [
      ...
      {
        "title": "لا أعرف كيف أقول ذلك؟ فقط اسأل Sophie.",
        "description": "لا تتعثر بعد الآن. إذا كنت بحاجة إلى العثور على كلمة أو عبارة أثناء التحدث، فما عليك سوى سؤال Sophie."
      },
      {
        "title": "ذكي",
        "description": "إذا كنت لا تعرف كيف تقول شيئًا ما، فلا تتردد فقط في سؤال Sophie."
      },
      {
        "title": "محادثة سلسة",
  ...
  "faq": {
    ...
    "items": [
      {
        "question": "هل تقوم Sophie بتدريس لهجات {language} المختلفة؟",
        "answer": "نعم! يمكنك التبديل بين اللهجات الإقليمية المختلفة ولهجات {language} في إعداداتك. تقوم Sophie بتكييف مفرداتها وتعبيراتها الشائعة ونطقها لتتناسب مع المنطقة المحددة التي تركز عليها."
      },
      {
        "question": "أنا مبتدئ تماما. هل هذا صعب للغاية؟",
        "answer": "مُطْلَقاً. تم تصميم Sophie للتكيف مع مستواك المحدد. إذا كانت المحادثة معقدة للغاية، يمكنك ببساطة أن تطلب منها التباطؤ، أو استخدام كلمات أبسط، أو حتى توفير ترجمة فورية لمساعدتك على المتابعة."
      },
      {
        "question": "كيف تساعد Sophie في القواعد النحوية المعقدة؟",
        "answer": "تستخدم Sophie نهج \"السياق أولاً\". بدلاً من التدريبات، تضعك في سيناريوهات من العالم الحقيقي تتطلب بطبيعة الحال قواعد نحوية معقدة. إذا ارتكبت خطأً ما، فإنها تقدم تعليقات لطيفة وبناءة في الوقت الفعلي. ({language})"
      },
      {
        "question": "ما هي المنصات التي تتوفر عليها Sophie؟",
        "answer": "Sophie متاحة حاليًا كتطبيق ويب وتطبيق جوال لكل من iOS وAndroid. تتم مزامنة تقدمك وقوائم المفردات المخصصة وسجل المحادثات عبر جميع أجهزتك."
      },
      {
        "question": "هل يمكنني التدرب على موضوعات محادثة محددة؟",
        "answer": "قطعاً. يمكنك الاختيار من بين العشرات من السيناريوهات المعدة مسبقًا - مثل الطلب في مقهى، أو اجتماع عمل، أو الموعد الأول - أو إنشاء موضوعاتك المخصصة. تستطيع Sophie التعامل مع أي محادثة ترغب في إجرائها تقريبًا."
      },
      {
        "question": "كم عدد اللغات التي تستطيع Sophie التحدث بها؟",
        "answer": "تدعم Sophie حاليًا 20 لغة عالمية رئيسية، ونقوم بإضافة المزيد كل شهر. يتم دعم كل لغة بنماذج الذكاء الاصطناعي على المستوى الأصلي لضمان تجربة التعلم الأكثر دقة وطبيعية قدر الإمكان."
      }
    ]
  },
  "loginPage": {
    ...
    "testimonial": "لقد دفعتني Sophie إلى التحدث منذ اليوم الأول. إنه منتج سلس وطبيعي وفعال بشكل لا يصدق.",
  ...
  "aboutPage": {
    ...
    "beginningP2": "في Sophie.ai، نعتقد أن أسرع طريق للثقة في لغة أخرى هو ممارسة التحدث يوميًا مع ردود فعل ذكية تبدو طبيعية وشبيهة بالبشر. Sophie ليست مجرد ذكاء اصطناعي - إنها شريكة متحدثة تستمع وتتكيف وتساعدك على ممارسة المحادثات الواقعية من اليوم الأول.",
  ...
  "methodologyPage": {
    ...
    "principles": [
      ...
      },
      {
        ...
        "description": "نحن لا نكرر الكلمات فقط. نكرر *الأنماط* ضمن سياقات جديدة. إذا كنت تواجه صعوبة في استخدام صيغة الشرط الإسبانية، فسوف تنسجها Sophie في نقاش حول السياسة، ثم في سيناريو التاريخ."
      },
      {
      ...
      },
      {
        ...
        "description": "تتطلب المرونة العصبية تصحيحًا فوريًا للأخطاء. تتدخل Sophie في اللحظة التي يحدث فيها خطأ، وتعيد كتابة المسار العصبي قبل أن تبدأ العادة السيئة (التحجر)."
      }
    ]
  },
  "supportPage": {
    ...
    "faqs": [
      {
        "q": "كيف أبدأ محادثة مع Sophie؟",
        "a": "افتح التطبيق، وانتقل إلى علامة تبويب \"التحدث\"، وحدد اللغة التي تريد تعلمها، واضغط مع الاستمرار على زر الميكروفون لبدء التحدث. سوف تستجيب Sophie في الوقت الحقيقي."
      },
      {
        "q": "ما هي اللغات التي تدعمها Sophie؟",
        "a": "تدعم Sophie حاليًا اللغة الإنجليزية والإسبانية والفرنسية والألمانية واليابانية والصينية (الماندرين) والهندية - مع توفر المزيد من اللغات قريبًا."
      },
      {
      ...
      {
        "q": "هل يمكنني استخدام Sophie دون اتصال بالإنترنت؟",
        "a": "تتطلب Sophie اتصالاً بالإنترنت لمعالجة محادثات الذكاء الاصطناعي وتقديم تعليقات في الوقت الفعلي."
      }
    ],
  ...
  "privacyPage": {
    ...
    "childrenBody": "خدمة التحدث مع Sophie غير موجهة للأطفال دون سن 13 عامًا. نحن لا نجمع معلومات شخصية عن عمد من الأطفال دون سن 13 عامًا. إذا كنت أحد الوالدين أو الوصي وتعتقد أن طفلك قد زودنا ببيانات شخصية، فيرجى الاتصال بنا حتى نتمكن من اتخاذ الإجراء المناسب.",
  ...
  "problemSolution": {
    ...
    "solutionBullets": [
      ...
      "لم تعد هناك حاجة إلى أن يكون لديك متحدث أصلي بشري للتدرب، فلديك Sophie."
    ],
    "resultLabel": "النتيجة:",
  ...
  "pricing": {
    ...
    "freeTierSubtitle": "لقاء وتحية Sophie",
    "freePriceSuffix": "7 أيام",
    "freeFeatures": [
      "التطبيق بـ 15 لغة",
      "محادثات طبيعية مع Sophie بأكثر من 50 لغة",
      "ترجمة Sophie من أي إلى أي لغة متاحة",
      "توفير عدد غير محدود من المفردات بجميع اللغات المتاحة.",
      "100+ سيناريوهات المحادثة"
    ],
    "premiumTierName": "SCF",
    "premiumBadge": "الأكثر شيوعًا",
    "premiumTierSubtitle": "Sophie صديق مقرب",
    ...
    "proTierSubtitle": "Sophie أفضل صديق",
    "bestValue": "أفضل قيمة",
    "proMonth": " 6 شهر",
    "proFeatures": [
      "كل شيء في Sophie الصديق المقرب",
  ...
  "testimonials": {
    ...
    "items": [
      {
        "quote": "لقد قضيت 4 سنوات في {language} في المدرسة الثانوية ولكن لم أتمكن من طلب تاكو. أصلحت Sophie خوفي من التحدث خلال أسبوعين.",
        "author": "James T.",
        "role": "مسافر"
      },
      {
        "quote": "سياق العالم الحقيقي أصبح منطقيًا أخيرًا. شرحت Sophie ذلك أثناء قيامنا بتمثيل مشهد في {nativeLanguage}.",
        "author": "Sarah M.",
        "role": "مغترب"
      },
      {
  ...
  "comparisonTable": {
    "title": "قارن خياراتك.",
    "subtitle": "تعرف على كيفية مواجهة Sophie لأساليب التعلم التقليدية والتطبيقات الأخرى. الفرق ليس فقط في السعر، بل في النتائج.",
    "columns": {
      "feature": "الميزة",
      "sophie": "Sophie.ai",
      "apps": "تطبيقات ملعبة",
  ...
  "appDownload": {
    "title": "حمّل التطبيق",
    "subtitle": "حمّل Sophie على هاتفك وابدأ التحدث اليوم.",
    "scanQrCode": "امسح للتحميل",
  ...
  "productTour": {
    ...
    "tabs": [
      ...
      },
      {
        ...
        "desc": "Sophie لا تحكم على أحد. لا تتردد في ارتكاب الأخطاء"
      }
    ],
  ...
  "personalizationEngine": {
    ...
    "subtitle": "تقوم معظم التطبيقات بإعادة ضبط كل جلسة. تقوم Sophie ببناء نموذج مستمر ومتطور لأنماط لغتك.",
    ...
    "steps": [
      ...
      {
        "title": "الوعي بالسياق",
        "desc": "تعرف Sophie أنك \"مهندسة برمجيات\" تحب \"المشي لمسافات طويلة\"، ولست مستخدمًا عامًا."
      }
    ]
  },
  "socialProof": {
  ...
  "cookieBanner": {
    ...
    "description": "نحن نستخدم ملفات تعريف الارتباط للتأكد من أن Sophie تتذكر تقدمك وإعداداتك. نحن نحترم خصوصيتك.",
    "accept": "يقبل",
    "decline": "انخفاض"
  },
  "blogPage": {
    ...
    "posts": [
      ...
      },
      {
        ...
        "title": "كيف تستخدم Sophie LLMs بشكل مختلف",
  ...
  "blogPostPage": {
    ...
    "sectionNeuroP2": "ولهذا السبب يمكن للذكاء الاصطناعي أن يكون شريكًا قويًا في الممارسة. Sophie لا تحكم عليك ولا تتعجل. إنها تقوم بالتصحيح والمضي قدمًا، مما يقلل من المرشح العاطفي ويساعد عقلك على تحمل المخاطر.",
  ...
  "signupModal": {
    ...
    "description": "Sophie حاليا في مرحلة تجريبية خاصة. احجز مكانك اليوم.",
  ...
  "demoModal": {
    "dialogTitle": "عرض المحاكاة الحية لSophie AI",

...
export const en: Messages = {
  ...
  "aboutPage": {
    ...
    "foundersP1": "We, Luis Alberto Olguin Reyes and Ernesto Olguin Roman, built this platform on one belief: anyone should be able to speak a new language with confidence, without fear, without judgment, and without boring drills. We created Sophie.ai to help learners everywhere speak boldly, frequently, and naturally.",
